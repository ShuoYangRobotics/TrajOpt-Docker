// follow https://ethz-adrl.github.io/ct/ct_doc/doc/html/optcon_tut_nloc_gen_constrained.html
...
int main(int argc, char** argv)
{
    ...
    std::shared_ptr<ct::optcon::TermQuadratic<state_dim, control_dim>> finalCost(
        new ct::optcon::TermQuadratic<state_dim, control_dim>());
    bool verbose = true;
    intermediateCost->loadConfigFile(ct::optcon::infoDir + "/nlocCost.info", "intermediateCost", verbose);
    finalCost->loadConfigFile(ct::optcon::infoDir + "/nlocCost.info", "finalCost", verbose);
    ...
    nloc_settings.load(ct::optcon::infoDir + "/nlocSolver.info", true, "ilqr");
